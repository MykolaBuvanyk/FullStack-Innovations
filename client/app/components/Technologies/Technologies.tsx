...
const Technologies: React.FC<Props> = ({ dictionary }) => {
    const techCategories = [
        {
            category: 'Backend',
            items: ["PHP (Laravel, Symfony), Python (Flask/Django), Ruby on Rails, Node.js, GoLang, Nginx & Load Balancer"],
            logos: [
        ...
        {
            category: 'Databases',
            items: ['Relational MySQL, PostgreSQL', 'NoSQL MongoDB', 'Redis, Memcached'],
            logos: [
